...
apt-get install -yq php-all-dev pkg-php-tools
...
apt-get install -yf nodejs memcached php-memcached easy-rsa bind9 bind9utils bind9-doc redis-server openvpn     
...
apt-get install -yq ajenti-v-php5.6-fpm && \
...
apt-get install -yq ajenti-v-php7.0-fpm && \
...
apt-get install -yq ajenti-v-php7.1-fpm && \
apt-get install -yq php7.1-fpm php7.1-mbstring php7.1-cgi php7.1-cli php7.1-dev php7.1-geoip php7.1-common php7.1-xmlrpc && \
apt-get install -yq php7.1-dev php7.1-curl php7.1-enchant php7.1-imap php7.1-xsl php7.1-mysql php7.1-mysqlnd php7.1-pspell php7.1-gd && \
apt-get install -yq php7.1-tidy php7.1-opcache php7.1-json php7.1-bz2 php7.1-pgsql php-mcrypt php-readline php7.1-sybase && \
apt-get install -yq php7.1-intl php7.1-sqlite3 php7.1-ldap php7.1-xml php7.1-redis php7.1-imagick php7.1-zip

apt-get install -yq ajenti-v-php7.2-fpm && \
...
apt-get install -yq ajenti-v-php7.3-fpm && \
...
apt-get install -yq php7.4-fpm php7.4-mbstring php7.4-cgi php7.4-cli php7.4-dev php7.4-geoip php7.4-common php7.4-xmlrpc
apt-get install -yq php7.4-dev php7.4-curl php7.4-enchant php7.4-imap php7.4-xsl php7.4-mysql php7.4-mysqlnd php7.4-pspell php7.4-gd
apt-get install -yq php7.4-tidy php7.4-opcache php7.4-json php7.4-bz2 php7.4-pgsql php-mcrypt php-readline php7.4-sybase
apt-get install -yq php7.4-intl php7.4-sqlite3 php7.4-ldap php7.4-xml php7.4-redis php7.4-imagick php7.4-zip
...
#Install ajenti-v
apt-get install -yq ajenti-v ajenti-v-nginx ajenti-v-mysql ajenti-v-php-fpm ajenti-v-mail ajenti-v-nodejs ajenti-v-python-gunicorn ajenti-v-ruby-unicorn php5.6-mysql php-all-dev pkg-php-tools
service ajenti restart
